...
INSERT INTO "new_SiteConfig" ("accentColor", "appUrl", "backendUrl", "blockDisposable", "captchaProvider", "captchaSecret", "captchaSiteKey", "cpfApiKey", "currencyConversion", "customScripts", "favicon", "featuredPlanId", "id", "logoDark", "logoLight", "ogImage", "plansColumns", "primaryColor", "sectionsJson", "seoJson", "signupPerDay", "signupPerHour", "siteUrl", "socialJson", "termsHtml", "termsUrl", "updatedAt", "whatsSubjects", "whatsapp") SELECT "accentColor", "appUrl", "backendUrl", "blockDisposable", "captchaProvider", "captchaSecret", "captchaSiteKey", "cpfApiKey", "currencyConversion", "customScripts", "favicon", "featuredPlanId", "id", "logoDark", "logoLight", "ogImage", "plansColumns", "primaryColor", "sectionsJson", "seoJson", "signupPerDay", "signupPerHour", "siteUrl", "socialJson", "termsHtml", "termsUrl", "updatedAt", "whatsSubjects", "whatsapp" FROM "SiteConfig";
